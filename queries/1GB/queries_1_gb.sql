...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 1070
...
select top 100 i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,2,6,10,10,4) and
       d_year = 2001 and
...
select top 100 *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (DATEADD(day,-30,'1999-06-22'))
                    and (DATEADD(day,30,'1999-06-22'))
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 63 and 63+10
          or ss_coupon_amt between 5791 and 5791+1000
...
select top 100 i_item_id
 ...
 and d_date between cast('2002-03-29' as date) and (DATEADD(day,60,'2002-03-29'))
 and i_manufact_id in (704,742,776,944)
...
select top 100 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (DATEADD(day,-30,'2001-05-02'))
                and (DATEADD(day,30,'2001-05-02'))
 group by
    w_state,i_item_id
...
select top 100 i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-01-13' as date) and (DATEADD(day,60,'2001-01-13'))
 and i_manufact_id in (258,558,580,484)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Sports','Men','Electronics') and
          i_class in ('fitness','sports-apparel','audio')
         )
