...
select case when (select count(*) 
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 3188916
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
with  cross_items as
 ...
 where ws_item_sk = iws.i_item_sk
   ...
   and d3.d_year between 2000 AND 2000 + 2) as SS
...
select top 100 i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,6,8,4,12,2) and
       d_year = 1998 and
...
select top 100 *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (DATEADD(day,-30,'2002-02-27'))
                    and (DATEADD(day,30,'2002-02-27'))
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 149 and 149+10
          or ss_coupon_amt between 6599 and 6599+1000
...
select top 100 i_item_id
 ...
 and d_date between cast('1999-02-21' as date) and (DATEADD(day,60,'1999-02-21'))
 and i_manufact_id in (856,988,1000,694)
...
select top 100 c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Five Points','Centerville','Oakland','Fairview','Five Points') 
...
select top 100 c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Five Points','Five Points')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Fairfield County','Ziebach County','Franklin Parish','Barrow County')
...
select top 100 i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-07-09' as date) and (DATEADD(day,60,'1999-07-09'))
 and i_manufact_id in (638,168,138,338)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where ss_item_sk = i_item_sk and
      ...
      or (i_category in ('Men','Shoes','Women') and
          i_class in ('accessories','womens','maternity') 
        ))
