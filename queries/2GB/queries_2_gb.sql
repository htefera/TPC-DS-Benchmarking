 ...
 from store_sales
     ...
     from (
      ...
      WHERE substring(ca_zip,1,5) IN (
                          '47601','16703','35863','28577','83909','36201',
                          '58411','48161','28055','41419','80331',
                          '38607','77817','24891','16225','18409',
                          '21231','59345','13917','51089','20317',
                          '17167','54585','67881','78365','47769',
                          '18359','51717','73107','14439','21799',
                          '89337','45859','65501','34947','25973',
                          '73219','25333','17291','10373','18829',
                          '60735','82619','41351','52093','19325',
                          '25213','54207','40935','21813','79077',
                          '25177','75741','77453','30621','89193',
                          '27369','41231','48567','83041','71947',
                          '37119','68341','14073','16891','62877',
                          '49129','19833','24285','27699','40979',
                          '50411','81503','94835','84843','71953',
                          '39503','57649','18433','24987','12349',
                          '86379','27413','44529','98569','16515',
                          '27287','24255','21093','16005','56435',
                          '91109','68293','56455','54557','10297',
                          '83647','32753','27051','51765','19443',
                          '13869','45645','94791','57631','20711',
                          '37787','41807','46507','21727','71835',
                          '81069','50631','88085','63991','20243',
                          '31655','51781','29817','63791','68605',
                          '94897','36429','57025','20601','82079',
                          '33869','22727','35833','29085','92645',
                          '98583','98071','11651','78093','57553',
                          '43829','71143','53565','18699','90209',
                          '71255','38353','54363','28571','96559',
                          '57839','56355','50679','45265','84679',
                          '34305','34971','48529','30105','15371',
                          '92379','84247','92291','68851','13337',
                          '34593','82601','70073','98069','85065',
                          '47289','11685','98861','26217','47529',
                          '63293','51793','35925','24227','14195',
                          '24593','32489','99059','49471','43431',
                          '49211','14311','88137','47369','56877',
                          '20533','81755','15793','12317','21059',
                          '73133','41255','63073','81003','73873',
                          '66057','51183','51195','45675','92695',
                          '70449','90669','98337','25263','38919',
                          '59225','58581','60297','17895','19489',
                          '52301','80845','95463','68769','51633',
                          '19987','18367','18421','11617','67975',
                          '25493','41351','95429','15733','62585',
                          '97173','33773','10425','75675','53535',
                          '17879','41967','12197','67997','79657',
                          '59129','72591','14851','43933','68101',
                          '50635','25717','71285','24659','58057',
                          '72991','95041','15543','33121','69279',
                          '11911','59385','27641','65177','17671',
                          '33467','64591','36335','54009','18767',
                          '63193','42361','49253','33113','33159',
                          '36479','59079','11855','81963','31015',
                          '49139','29391','41835','32957','53163',
                          '13843','73145','23951','65147','93497',
                          '14529','46131','58453','13375','13377',
                          '83985','12319','17193','59851','46081',
                          '98533','52389','13085','68843','31013',
                          '13261','60559','13443','45533','83583',
                          '11489','58217','19753','22911','25115',
                          '86709','27155','32669','13123','51933',
                          '39213','41331','66943','14155','69997',
                          '49101','70069','35075','14241','73021',
                          '59493','15781','29751','37913','74685',
                          '83085','34473','15751','81083','49229',
                          '91893','60623','17819','28809','63179',
                          '56223','39459','55233','75751','43639',
                          '55349','86057','62361','50787','31829',
                          '58061','18217','85761','60083','45483',
                          '21203','90229','70041','41161','35389',
                          '16363','39499','68907','26689','52867',
                          '81335','40145','11339','61527','61793',
                          '71997','30415','59003','29449','58117',
                          '69951','33561','83833','27385','61859',
                          '96435','48333','23065','32961','84919',
                          '61997','99131','22815','56599','68729',
                          '48017','95693','32919','88217','27115',
                          '28239','58031','18883','16791','21343',
                          '97461','18569','75659','15475')
     intersect
      select ca_zip
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 3136
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 39160
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 61326
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 53906
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 18842
            then (select avg(ss_ext_tax)
                  from store_sales
...
select top 100 i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,10,4,12,4,8) and
       d_year = 1999 and
...
select top 100 *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (DATEADD(day,-30,'1999-04-15'))
                    and (DATEADD(day,30,'1999-04-15'))
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 27 and 27+10
          or ss_coupon_amt between 5127 and 5127+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 1 and 1+10
          or ss_coupon_amt between 917 and 917+1000
...
select top 100 i_item_id
 ...
 and d_date between cast('2000-01-08' as date) and (DATEADD(day,60,'2000-01-08'))
 and i_manufact_id in (667,692,680,688)
...
select top 100 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (DATEADD(day,-30,'2000-02-01'))
                and (DATEADD(day,30,'2000-02-01'))
 group by
    w_state,i_item_id
...
select top 100 i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-04-17' as date) and (DATEADD(day,60,'2001-04-17'))
 and i_manufact_id in (260,970,128,150)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Electronics','Shoes','Sports') and
          i_class in ('automotive','womens','outdoor')
         )
      or (i_category in ('Sports','Men','Women') and
          i_class in ('camping','sports-apparel','fragrances') 
        ))
